...
interface Props {
  items: CulturalExperience[];
}

export default function ExperiencesSection({ items }: Props) {
  return (
    <FadeIn className="space-y-6">
      <div className="flex items-center gap-3 border-b border-foreground/10 pb-3">
        <Users className="h-6 w-6 text-accent" />
        <h2 className="text-2xl font-bold tracking-tight text-foreground">Cultural Experiences</h2>
      </div>
